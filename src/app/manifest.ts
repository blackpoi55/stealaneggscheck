...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    description: `ไข่ครบทั้ง ${EGGS.length} ใบใน Steal an Egg แยกตามไบโอม พร้อมรูปไข่จริงและเพ็ตจริง · All ${EGGS.length} Steal an Egg eggs grouped by biome, with real art.`,
    lang: "th",
    start_url: "/",
    scope: "/",
    display: "standalone",
