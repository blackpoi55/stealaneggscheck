...
- **ตัวจับเวลาประตูบอส** นับถอยหลังว่าอีกกี่นาทีประตู Rift จะเปิดให้ไปตี Abyss Overlord (ทุก 30 นาที) พร้อมเสียงเตือนล่วงหน้า 1 นาที (ดีฟอลต์ปิด) และตัวจับเวลาหมุนชุดไข่ริฟต์ (ทุก 3 ชม.)
...
**เสียงเตือน:** ปุ่มเปิด/ปิดอยู่บนการ์ด ดีฟอลต์ปิด จำค่าไว้ในเครื่อง เตือนล่วงหน้า 1 นาที และตอนเปลี่ยนจริงอีกครั้ง
เสียงสร้างด้วย Web Audio ไม่ต้องโหลดไฟล์ และ AudioContext ถูกสร้างตอนกดปุ่ม ซึ่งเป็น user gesture ที่มือถือต้องการ
