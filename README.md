...
หมายเหตุ: เงินโบนัสครั้งแรกไม่ได้เก็บไว้ในข้อมูล เพราะทุกรายการในแหล่งอ้างอิงเป็น `รายได้ต่อวินาที × 100`
จึงคำนวณจากสูตรนี้แทน · ส่วนโบนัสความเร็วของ Scorpion ไม่มีระบุในวิกิ จึงแสดงเป็น `—`
