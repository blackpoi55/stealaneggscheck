...
**ถ้ายังไม่ได้ตั้ง** ตัวจับเวลาบอกจะเดาจากนาฬิกา (นาทีที่ :00 กับ :30) เพื่อให้มีเลขนับถอยหลังให้ดูเสมอ
และติดป้าย *"ตามนาฬิกา :00 / :30 · Clock estimate"* ไว้ชัดเจนว่ายังไม่ได้ยืนยันกับในเกม
(เวลาไทยเป็น UTC+7 ซึ่งเป็นออฟเซ็ตเต็มชั่วโมง ขอบเขต :00/:30 จึงตรงกันทั้งเวลาไทยและ UTC)

**นาฬิกาของใครถูก:** ยังไม่มีแหล่งไหนยืนยันว่ารอบ 30 นาทีตรงกันทุกเซิร์ฟหรือแยกตามเซิร์ฟ การ์ดบอสจึงมีปุ่ม
**"ตั้งเวลาจากในเกม"** ให้ผู้เล่นกรอกตัวเลขจากเซิร์ฟตัวเองได้ เก็บไว้ในเครื่อง และจะถูกใช้แทนเวลากลางเสมอ
พอครบรอบก็บวกต่อไปอีก 30 นาทีเอง
