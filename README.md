...
เตือน **3 จังหวะต่อรอบ** — เหลือ **5 นาที** → เหลือ **1 นาที** → **ตอนประตูเปิด**
จังหวะที่ผ่านไปแล้วตอนเปิดหน้าเว็บจะไม่ย้อนมาเตือน และการ re-sync กับเซิร์ฟเวอร์ก็ไม่ทำให้เตือนซ้ำ
...
> **ขอบเขต:** แจ้งเตือนทำงานตอนหน้าเว็บ/แอปยัง**เปิดอยู่** (จะย่อไว้เบื้องหลังก็ได้)
> ถ้าปิดสนิทต้องใช้ Web Push ซึ่งต้องมี VAPID key + เซิร์ฟเวอร์คอยยิงตามเวลา และ cron ที่ยิงได้ถี่กว่าวันละครั้ง
